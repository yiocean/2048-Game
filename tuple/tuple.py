...
class Tuple():
    ...
    def getTupleValueSum(self, board):
        sumnum = 0
        self.value[0] = self.cot16(board[0][0], board[0][1], board[1][0], board[1][1])
        self.value[1] = self.cot16(board[0][2], board[0][3], board[1][2], board[1][3])
        self.value[2] = self.cot16(board[2][0], board[2][1], board[3][0], board[3][1])
        self.value[3] = self.cot16(board[2][2], board[2][3], board[3][2], board[3][3])
        for i in range(4):
            self.value[i+3] = self.cot16(board[i][0], board[i][1], board[i][2], board[i][3])
        for i in range(4):
            self.value[i+7] = self.cot16(board[0][i], board[1][i], board[2][i], board[3][i])
        self.value[12] = self.cot16(board[0][1], board[0][2], board[1][1], board[1][2])
        self.value[13] = self.cot16(board[1][0], board[1][1], board[2][0], board[2][1])
        self.value[14] = self.cot16(board[1][1], board[1][2], board[2][1], board[2][2])
        self.value[15] = self.cot16(board[1][2], board[1][3], board[2][1], board[2][2])
        self.value[16] = self.cot16(board[2][1], board[2][2], board[3][1], board[3][2])
